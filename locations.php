...
// Preluăm locațiile
$stmt = $pdo->query("SELECT * FROM Locations ORDER BY LocationID ASC");
...
<head>
    <meta charset="UTF-8">
    <title>DroneFleet Manager - Locații</title>
...
<body class="dashboard-layout">
    ...
    <div class="top-bar-dashboard">
        <div class="logo"><a href="home.html"><img src="logo1.png" alt="Logo"></a></div>
        <nav>
    ...
    <div class="main-content">
        <section id="locations">
            <header class="dashboard-header"><h1>Locații și Baze</h1></header>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-family: monospace; color: #555;"><?= htmlspecialchars($loc['Coordinates']) ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
